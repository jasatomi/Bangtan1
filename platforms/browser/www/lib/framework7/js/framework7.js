...
function load(loadParams, loadOptions, ignorePageChange) {
  ...
  } else if (component || linkUrl) {
    // Load from component (F7/Vue/React/...)
    try {
      router.pageComponentLoader(router.el, component, linkUrl, options, resolve, reject);
    } catch (err) {
      router.allowPageChange = true;
      throw err;
    }
...
function navigate(navigateParams, navigateOptions) {
  ...
  ('url content component pageName el linkUrl template templateUrl').split(' ').forEach(function (pageLoadProp) {
    var obj;
...
function tabLoad(tabRoute, loadOptions) {
  ...
  function loadTab(loadTabParams, loadTabOptions) {
    ...
    var linkUrl = loadTabParams.linkUrl;
    ...
    if (content) {
      ...
      // Load from component (F7/Vue/React/...)
      try {
        router.tabComponentLoader($newTabEl[0], component, linkUrl, loadTabOptions, resolve, reject);
      } catch (err) {
        router.allowPageChange = true;
        throw err;
      }
  ...
  ('url content component el linkUrl template templateUrl').split(' ').forEach(function (tabLoadProp) {
    var obj;
...
function modalLoad(modalType, route, loadOptions) {
  ...
  function loadModal(loadModalParams, loadModalOptions) {
    ...
    var linkUrl = loadModalParams.linkUrl;
    ...
    if (content) {
      ...
      // Load from component (F7/Vue/React/...)
      try {
        router.modalComponentLoader(app.root[0], component, linkUrl, loadModalOptions, resolve, reject);
      } catch (err) {
        router.allowPageChange = true;
        throw err;
      }
  ...
  ('url content component el linkUrl template templateUrl').split(' ').forEach(function (modalLoadProp) {
    var obj;
...
var Router = (function (Framework7Class$$1) {
  ...
  Router.prototype.componentLoader = function componentLoader (component, linkUrl, options, resolve, reject) {
    if ( options === void 0 ) options = {};

    var router = this;
    var url = typeof component === 'string' ? component : linkUrl;
    function compile(c) {
  ...
  Router.prototype.modalComponentLoader = function modalComponentLoader (rootEl, component, linkUrl, options, resolve, reject) {
    var router = this;
    router.componentLoader(component, linkUrl, options, function (el) {
      resolve(el);
    }, reject);
  };
  Router.prototype.tabComponentLoader = function tabComponentLoader (tabEl, component, linkUrl, options, resolve, reject) {
    var router = this;
    router.componentLoader(component, linkUrl, options, function (el) {
      resolve(el);
    }, reject);
  };
  Router.prototype.pageComponentLoader = function pageComponentLoader (routerEl, component, linkUrl, options, resolve, reject) {
    var router = this;
    router.componentLoader(component, linkUrl, options, function (el, newOptions) {
      if ( newOptions === void 0 ) newOptions = {};
